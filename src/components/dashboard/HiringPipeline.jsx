...
// const SkeletonRow = () => (
//   <div className="grid grid-cols-6 items-center py-3 animate-pulse">
...
//   return (
//     <div className="bg-white rounded-2xl shadow p-4 w-full h-[250px] overflow-auto">
//       {/* Header */}
...
//           </select>
//           <button className="text-sm font-medium px-3 py-1 border rounded-lg">
//             VIEW ALL
//           </button>
//         </div>
//       </div>
...
//         {/* Table Header (sticky) */}
//         <div className="grid grid-cols-6 text-sm font-medium text-gray-500 border-b pb-2 mb-2 sticky top-0 bg-white z-10">
//           <div>Jobs</div>
//           <div>New Applied</div>
//           <div>Screening</div>
//           <div>Interview</div>
...
//               <div
//                 key={idx}
//                 className="grid grid-cols-6 items-center py-3 text-sm border-b last:border-none"
//               >
//                 {/* Job Name */}
//                 <div>
...
//                 {job.stages.map((stage, sIdx) => (
//                   <div key={sIdx}>
//                     <span
//                       className={`px-2 py-2 rounded-md text-xs min-h-[40px] w-[100px] min-w-[80px] font-medium flex items-center justify-center ${stage.color}`}
//                     >
//                       {stage.label || ""}
//                     </span>
//                   </div>
